...
default_max_force = Boid.max_force
default_perception = Boid.perception
default_crowding = Boid.crowding
...
def main(args):
    ...
    # Apply runtime configuration before spawning boids.
    Boid.max_force = args.max_force
    Boid.perception = args.perception
    Boid.crowding = args.crowding
...
if __name__ == "__main__":
    ...
    parser.add_argument('--number', dest='num_boids', type=int,
                        default=default_boids, help='number of boids to generate')
    parser.add_argument('--max_force', type=float, default=default_max_force,
                        help='maximum steering force per boid')
    parser.add_argument('--perception', type=float, default=default_perception,
                        help='distance within which other boids influence steering')
    parser.add_argument('--crowding', type=float, default=default_crowding,
                        help='distance threshold for separation behavior')
